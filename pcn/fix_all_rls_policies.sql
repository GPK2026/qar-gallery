...
--   • Chats löschen             (threads/messages DELETE)
--
-- SICHERHEITSHINWEIS
-- Dieses Setup vertraut der Anwendungsschicht, nicht der Datenbank.
-- Das ist für den Pilotbetrieb vertretbar (geschlossene Club-Community,
-- Zugang nur über Club-Code), sollte aber vor einem breiten Rollout durch
-- echte Supabase-Auth ersetzt werden. Siehe Abschnitt "ROADMAP" unten.
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- KONTROLLE — sollte für jede Tabelle SELECT/INSERT/UPDATE/DELETE oder ALL zeigen
-- ═══════════════════════════════════════════════════════════════════════════
...
--
-- Bis dahin schützt: Club-Code beim Login, anon key ohne Schreibrechte auf
-- fremde Datensätze über die App-Logik, und die geschlossene Nutzergruppe.
-- ═══════════════════════════════════════════════════════════════════════════
