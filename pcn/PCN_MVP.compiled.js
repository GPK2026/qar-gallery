(function (global, factory) {
  ...
  function ChatScreen({
    ...
    const other = isAdminThread ? {
      ...
      name: isClubChannel ? thread.name || "PCN Mitglieder" : "Mitglied"
    };
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      style: {
        ...
        gap: 12,
        alignItems: "center",
        marginBottom: isClubChannel ? 6 : 0
      }
    }, /*#__PURE__*/_react.default.createElement("button", {
      onClick: onBack,
      style: {
      ...
      style: {
        width: 44,
        height: 44,
        borderRadius: isClubChannel ? "12px" : "50%",
        ...
        justifyContent: "center",
        fontWeight: 800,
        fontSize: isClubChannel ? 22 : 17,
        flexShrink: 0
      }
    }, isAdminThread ? "📣" : isClubChannel ? "🏎️" : thread.anonymous ? "🔒" : other.name[0]?.toUpperCase()), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        flex: 1,
        minWidth: 0
      }
    ...
    }, isAdminThread ? "📣 PCN Vorstand" : isClubChannel ? thread.name || "PCN Mitglieder" : thread.anonymous ? "🔒 Anonyme Nachricht" : other.name), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 12,
        color: C.muted,
        marginTop: 2
      }
    }, isClubChannel ? `${threadParticipants.filter(p => p !== ADMIN_UUID).length} Mitglieder` : isAdminThread ? "Offizielle Mitteilung" : v ? `Re: ${v.hersteller} ${v.modell}` : "Direktnachricht")), !isClubChannel && v && /*#__PURE__*/_react.default.createElement("button", {
    ...
    }, "🗑")), isClubChannel && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        display: "flex",
        gap: 6,
        paddingLeft: 56,
      ...
      const senderName = isAdminMsg && !mine ? "📣 PCN Vorstand" : isClubChannel ? mine ? "Du" : senderUser?.name || "Mitglied" : null;
  ...
  function PCNInner() {
    ...
    const [newsTick, setNewsTick] = (0, _react.useState)(0); // erzwingt Re-Render wenn window._dbNews sich ändert
        ...
        await fetch(`${sbUrl()}/rest/v1/messages`, {
          ...
          body: JSON.stringify({
            ...
            payload: JSON.stringify({
              ...
              qarId: vehicle.qarId || vehicle.qar_id
            }),
            created_at: new Date().toISOString()
          })
        });
    ...
    const confirmScan = async (scannerId, vehicleId, scannerName) => {
      ...
      if (!isDemo) {
        ...
        try {
          ...
          console.warn("Scan-Bestätigung nicht zugestellt:", e);
        }
      }
...
- istFahrezugschein: false wenn es offensichtlich ein anderes Dokument ist`
    ...
    const loadDemo = async () => {
      ...
      if (DB && DB.backend === "local") {
        ...
        if (DB) {
          ...
          try {
            const newsResp = await fetch(`${sbUrl()}/rest/v1/news?select=*&order=created_at.desc&limit=20`, {
              headers: {
                "apikey": sbKey(),
                "Authorization": "Bearer " + sbKey()
              }
  ...
  `;
    ...
    }, "← Zurück zum Chat"), SPONSOR && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        marginTop: 20
      }
    }, /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, "Offizieller Partner"), /*#__PURE__*/_react.default.createElement("a", {
      href: SPONSOR.url,
      target: "_blank",
    ...
    }, SPONSOR.name), SPONSOR.subtitle && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 10,
        color: "#888",
        marginTop: 1
      }
    }, SPONSOR.subtitle), SPONSOR.tagline && /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 9,
        color: C.red,
        fontWeight: 700,
    ...
    }, SPONSOR.tagline)), /*#__PURE__*/_react.default.createElement("span", {
      style: {
        fontSize: 16,
        color: "#ccc"
      }
    ...
    return /*#__PURE__*/_react.default.createElement("div", {
    ...
    }, "Scanne einen QR-Code und schreibe dem Fahrzeughalter")), !isGuest && (() => {
      ...
      const lastSender = lastClub && lastClub.from !== ADMIN_UUID ? Object.values(allUsers).find(u => u.id === lastClub.from)?.name || "Mitglied" : null;
      return /*#__PURE__*/_react.default.createElement("div", {
        style: {
          marginBottom: 16
        }
        ...
        onClick: () => {
          setActiveThread(liveClub ? CLUB_CHANNEL_ID : "GROUP_PCN");
          setScreen("chat");
        }
      }, /*#__PURE__*/_react.default.createElement("div", {
        style: {
      ...
      }, "PCN Mitglieder"), unreadClub > 0 && /*#__PURE__*/_react.default.createElement("span", {
        style: {
          background: C.red,
          color: "#fff",
          borderRadius: 99,
      ...
      }, unreadClub)), /*#__PURE__*/_react.default.createElement("div", {
        style: {
          fontSize: 12,
          color: `${C.red}99`,
          marginBottom: 2
        }
      }, "Gruppen-Kanal · ", memberCount, " Mitglieder"), /*#__PURE__*/_react.default.createElement("div", {
        style: {
          fontSize: 13,
          color: C.muted,
          overflow: "hidden",
      ...
      }, lastClub ? `${lastSender ? lastSender + ": " : lastClub.from === ADMIN_UUID ? "📣 Vorstand: " : ""}${lastClub.text}` : "Noch keine Nachrichten"))));
    })(), !isGuest && /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 11,
        fontWeight: 800,
        color: C.muted,
      ...
      }, "Du hast ", pending.length, " Fahrzeug", pending.length > 1 ? "e" : "", " gescannt. Sobald der Besitzer bestätigt, erhältst du +", POINTS.qr_scan.toLocaleString("de-DE"), " Punkte je Scan. Die Bestätigung erfolgt automatisch über den Admin-Chat des Besitzers."));
    })(), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        background: C.card,
        border: `1px solid ${C.border}`,
    ...
    }, "🏁 die 911 im Kurs")), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 22,
        fontWeight: 900,
        color: C.white,
    ...
    }, "911 Punkte = 3 €"), /*#__PURE__*/_react.default.createElement("div", {
      style: {
        fontSize: 11,
        color: C.muted,
        marginTop: 3
      ...
      color: "#e879f9",
      items: [["🎂", "Geburtstag", "+" + POINTS.birthday], ["🎉", "Runder Geburtstag (= 3 €)", "+" + POINTS.birthday_round]]
    ...
    }, "Beispiele"), [["QR-Sticker", 5.9], ["Schlüsselanhänger", 25], ["Porsche Cap", 35], ["Modellauto 1:43", 60]].map(([n, p]) => {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        style: {
          fontSize: 11,
          color: have ? C.green : "#888"
        }
      }, have ? "✓ " : "", n), /*#__PURE__*/_react.default.createElement("span", {
        style: {
          fontSize: 11,
          color: have ? C.green : "#666",
          fontWeight: 700,
          fontFamily: "'Barlow Condensed',sans-serif"
        }
